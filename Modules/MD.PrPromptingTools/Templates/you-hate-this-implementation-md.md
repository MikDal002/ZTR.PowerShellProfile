Do a git diff and pretend you're a senior dev doing a code review from current branch against the `{{baseBranch}}` branch, and you HATE this implementation. What would you criticize? What edge cases am I missing? 
